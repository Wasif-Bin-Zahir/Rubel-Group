                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            @if(Route::currentRouteName()=='backend.setting.numbers.index')
                            <h3 class="card-title mt-1"> Numbers</h3>
                            @else
                            ...
                            @if(Route::currentRouteName()=='backend.setting.numbers.index')
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exhibitors" class="@error('exhibitors') text-danger @enderror">Exhibitors</label>
                                        <input id="exhibitors" name="exhibitors" value="{{ old('exhibitors') ?: $contact->exhibitors }}" type="text" class="form-control @error('exhibitors') is-invalid @enderror" placeholder="Enter exhibitors" autofocus>
                                        @error('exhibitors')
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="participantes" class="@error('participantes') text-danger @enderror">Participantes</label>
                                        <input id="participantes" name="participantes" value="{{ old('participantes') ?: $contact->participantes }}" type="text" class="form-control @error('participantes') is-invalid @enderror" placeholder="Enter participantes" autofocus>
                                        @error('participantes')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="countries" class="@error('countries') text-danger @enderror">Countries</label>
                                        <input id="countries" name="countries" value="{{ old('countries') ?: $contact->countries }}" type="text" class="form-control @error('countries') is-invalid @enderror" placeholder="Enter countries" autofocus>
                                        @error('countries')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="registered_user" class="@error('registered_user') text-danger @enderror">Registered user</label>
                                        <input id="registered_user" name="registered_user" value="{{ old('registered_user') ?: $contact->registered_user }}" type="text" class="form-control @error('registered_user') is-invalid @enderror" placeholder="Enter registered_user" autofocus>
                             ...
                             @else
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="working_hours" class="@error('working_hours') text-danger @enderror">Event Time</label>
