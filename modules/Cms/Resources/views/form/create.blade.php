                                ...
                                <div class="row">
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="data" name="data" class="form-control" rows="3" placeholder="Enter data">{{ old('data') }}</textarea>
                                            @error('data')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="agent_info" name="agent_info" value="{{ old('agent_info') }}" type="text" class="form-control @error('agent_info') is-invalid @enderror" placeholder="Enter agent_info" autofocus>
                                            @error('agent_info')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="type" name="type" value="{{ old('type') }}" type="text" class="form-control @error('type') is-invalid @enderror" placeholder="Enter type" autofocus>
                                            @error('type')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
