                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">{{ $category->title }} Details</h3>
                            <a href="{{ route('backend.cms.content.index', ['category_id' => $content->content_category_id]) }}" type="button" class="btn btn-success btn-sm text-white float-right">View {{ $category->title }} List</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="title_bn" name="title_bn" value="{{ $content->title_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('title_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
									...
									<div class="col-md-12">
                                    <div class="form-group">
                                        <label for="content_category_id" class="@error('content_category_id') text-danger @enderror">{{ $category->title }} Category Id</label>
                        ...
                        <div class="card-footer">
                            <a href="{{ route('backend.cms.content.index', ['category_id' => $content->content_category_id]) }}" type="button" class="btn btn-dark text-white float-right">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
