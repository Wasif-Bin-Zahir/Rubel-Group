                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Edit {{ $category->title }}</h3>
                            <a href="{{ route('backend.cms.content.index', ['category_id' => $content->content_category_id]) }}" type="button"
                               class="btn btn-success btn-sm text-white float-right">View {{ $category->title }} List</a>
                        </div>
                        {!! Form::open(['url' => route('backend.cms.content.update', [$content->id]), 'method' => 'put', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <input id="content_category_id" name="content_category_id" value="{{ $content->content_category_id }}" type="hidden">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="title_bn" name="title_bn" value="{{ old('title_bn') ?: $content->title_bn }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description_bn" name="description_bn" class="form-control" rows="3"
                                                  placeholder="Enter description_bn">{!! old('description_bn') ?: $content->description_bn !!}</textarea>
                                ...
                                @if($category->id == 1)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="start_date" name="start_date" value="{{ old('start_date') ? old('start_date') : $content->start_date  }}" type="text" class="form-control datepicker @error('start_date') is-invalid @enderror" placeholder="Enter display date" autofocus>
                                            @error('start_date')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="end_date" name="end_date" value="{{ old('end_date') ? old('end_date') : $content->end_date  }}" type="text" class="form-control datepicker @error('end_date') is-invalid @enderror" placeholder="Enter display date" autofocus>
                                            @error('end_date')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="sort_order" name="sort_order"
                                            value="{{ old('sort_order') ?: $content->sort_order }}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if(isset($content->attachment->file_url))
                                            <div class="main-image">
                                                <object data="{{$content->attachment->file_url}}" type="application/pdf" width="100%" height="100px">
                                                <p>Unable to display PDF file. <a href="{{$content->attachment->file_url}}">Download</a> instead.</p>
                                                </object>
                                            </div>
                                        @endif
                                        @error('attachment')
