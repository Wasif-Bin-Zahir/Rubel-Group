                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="title_bn" name="title_bn" value="{{ old('title_bn') }}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description_bn" name="description_bn" class="form-control" rows="3"
                                                  placeholder="Enter description">{{ old('description_bn') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="article_category_id"
                                               class="@error('article_category_id') text-danger @enderror">Category <span class="text-danger">*</span></label>
