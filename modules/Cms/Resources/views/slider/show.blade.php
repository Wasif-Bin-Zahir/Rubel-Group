                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="title_bn" name="title_bn" value="{{ $slider->title_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('title_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="description_bn" name="description_bn" value="{{ $slider->description_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
