                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="sort_order" name="sort_order" value="{{ old('sort_order') }}"
                                               type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="link" name="link" value="{{ old('link') }}" type="text" class="form-control @error('link') is-invalid @enderror" placeholder="Enter title" autofocus>
                                        @error('link')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
