                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Committee Category Details</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="title" name="title" value="{{ $committeeCategory->title ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('title')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="title_bn" name="title_bn" value="{{ $committeeCategory->title_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('title_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="description" name="description" value="{{ $committeeCategory->description ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="description_bn" name="description_bn" value="{{ $committeeCategory->description_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
