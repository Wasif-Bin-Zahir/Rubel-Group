                    ...
                    <div class="card card-purple card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="name_bn" class="@error('name_bn') text-danger @enderror">Name</label>
                                        <input id="name_bn" name="name_bn" value="{{ $testimonial->name_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('name_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
