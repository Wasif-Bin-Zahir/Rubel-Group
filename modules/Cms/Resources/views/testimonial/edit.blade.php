                    ...
                    <div class="card card-purple card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name_bn" class="@error('name') text-danger @enderror">Name (Bengali)</label>
                                        <input id="name_bn" name="name_bn" value="{{ old('name_bn') ?: $testimonial->name_bn }}" type="text" class="form-control @error('name_bn') is-invalid @enderror" placeholder="Enter name" autofocus>
                                        @error('name_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="message_bn" name="message_bn" class="form-control" rows="3" placeholder="Enter message">{{ old('message_bn') ?: $testimonial->message_bn }}</textarea>
                                        @error('message_bn')
