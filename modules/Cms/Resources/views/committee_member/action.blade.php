<div class="btn-group">
    <a href="{{ route('backend.cms.committee-member.show', [$data->id]) }}" type="button" class="btn btn-default">
        <i class="fas fa-eye"></i>
    </a>
    <a href="{{ route('backend.cms.committee-member.edit', [$data->id]) }}" type="button" class="btn btn-default">
    ...
    {!! Form::open(['url' => route('backend.cms.committee-member.destroy', [$data->id]), 'method' => 'delete', 'id' => 'delete_form' . $data->id]) !!}{!! Form::close() !!}
</div>
