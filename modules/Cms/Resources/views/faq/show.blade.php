                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="question_bn" name="question_bn" value="{{ $faq->question_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('question_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="description" name="answer_bn" value="{{ $faq->answer_bn ?: 'N/A'}}" type="text" class="form-control-plaintext" readonly>
                                        @error('answer_bn')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
