    ...
    <div class="banner-area">
        <div class="hero-slider owl-carousel owl-theme">
            @foreach ($data->sliders as $slider)
                <div class="slider-item bg-1" style="background-image:url({{ $slider->image->file_url ?? url('images/default/thumb_3.jpg') }}) !important">
                    <div class="container-fluid">
                        <div class="banner-content">
                            <h1>@if (app()->getLocale() == 'bn')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-image-content pr-15">
                        <img src="{{ $data->welcomeMessage->image->file_url ?? url('images/default/thumbnail.jpeg') }}" alt="Image">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about-content pl-15">
                        <div class="about-title">
                            ...
                            <h2>@if(app()->getLocale() == 'bn')
                                            {{ $data->welcomeMessage->title_bn ?? $data->welcomeMessage->title }}
                                        @else
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="who-we-are-img pl-15">
                        <img src="{{ $data->aboutorganiser->image->file_url ?? url('images/default/thumbnail.jpeg') }}" alt="Image">
                        <div class="shape-1">
                            <img src="{{ $data->aboutorganiser->image->file_url ?? url('images/default/thumbnail.jpeg') }}" alt="Image">
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                    <div class="single-blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{asset('assets/images/blog/blog-img-1.jpg')}}" alt="Image"></a>
                            <div class="date">
                                <p>09</p>
                                <span>May</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
                    <div class="single-blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{asset('assets/images/blog/blog-img-2.jpg')}}" alt="Image"></a>
                            <div class="date">
                                <p>09</p>
                                <span>May</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
                    <div class="single-blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="{{asset('assets/images/blog/blog-img-3.jpg')}}" alt="Image"></a>
                            <div class="date">
                                <p>09</p>
                                <span>May</span>
                            </div>
