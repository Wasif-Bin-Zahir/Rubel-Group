                    ...
                    <div class="bread-inner">
                        <div class="bread-menu">
                            <ul>
                                ...
                                <li><a href="javascript:void(0)">{{__('cms.sponsors')}}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    @foreach($data->notices as $notice)
                        <div class="col-lg-4 col-md-6 col-12">
                            <a href="{{ url('sponsors/' . $notice->slug) }}">
                                <div class="blog-item-4" style="cursor: pointer;">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <h3 class="blog-item-title"><a href="{{ url('sponsors/' . $notice->slug) }}">{{ substr($notice->title, 0, 25) }}</a></h3>
