            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="contact-form-area m-top-30">
                        <h4 style="color:wheat;text-align:center">{{__('cms.get_in_touch')}}</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group button">
                                        <button type="submit" class="bizwheel-btn theme-1" style="background-color: wheat;color:#053B50;font-weight:bold";>{{__('cms.send_now')}}</button>
                                    </div>
                                </div>
                            </div>
                        {!! Form::close() !!}
