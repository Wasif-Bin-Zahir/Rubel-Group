                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="blog-single-main">
                                ...
                                @if(isset($data->news->attachment->file_url))
                                    <div class="main-image">
                                        <object data="{{$data->news->attachment->file_url}}" type="application/pdf" width="100%" height="500px">
                                        <p>Unable to display PDF file. <a href="{{$data->news->attachment->file_url}}">Download</a> instead.</p>
                                        </object>
                                    </div>
                                @endif
                            </div>
