                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Add Language Info</h3>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="proficiency" name="proficiency"
                                            ...
                                            @foreach(config('core.language_proficiency') as $language_proficiency_key => $language_proficiency)
                                                <option value="{{ $language_proficiency_key }}" {{ $language_proficiency_key == old('proficiency') ? 'selected' : '' }}>{{ $language_proficiency }}</option>
                                            @endforeach
                                        </select>
                                        @error('proficiency')
                                        <span class="invalid-feedback"
