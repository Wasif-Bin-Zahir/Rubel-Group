                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Academic Session Details</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="name" name="name" value="{{ $academicSession->name ?: 'N/A'}}" type="text"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="code" name="code"
                                               value="{{ $academicSession->code ?: 'N/A'}}" type="text"
                                               class="form-control-plaintext" readonly>
                                        @error('code')
                                        <span class="invalid-feedback"
                                              role="alert"><strong>{{ $message }}</strong></span>
