                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            ...
                            <a href="{{ route('backend.ums.academic-session.index') }}" type="button" class="btn btn-success btn-sm text-white float-right">View Academic Session List</a>
                        </div>
                        {!! Form::open(['url' => route('backend.ums.academic-session.store'), 'method' => 'batch', 'files' => true]) !!}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('backend.ums.academic-session.index') }}" type="button" class="btn btn-dark text-white float-right">Cancel</a>
                            </div>
                        {!! Form::close() !!}
                    </div>
                </div>
