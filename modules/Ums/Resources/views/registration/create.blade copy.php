                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">New Registration</h3>
                        ...
                        {!! Form::open(['url' => route('backend.ums.registration.store'), 'method' => 'post', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="bsc_session_id" name="bsc_session_id"
                                            ...
                                            @foreach($sessions as $session)
                                                <option value="{{ $session->id }}" {{ old('bsc_session_id') == $session->id ? 'selected' : '' }}>{{ $session->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="bsc_batch_id" name="bsc_batch_id"
                                            ...
                                            @foreach($batches as $batch)
                                                @if($batch->type == 1)
                                                    <option value="{{ $batch->id }}" {{ old('bsc_batch_id') == $batch->id ? 'selected' : '' }}>{{ $batch->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        @error('bsc_batch_id')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bsc_reg_no" class="@error('bsc_reg_no') text-danger @enderror">Designation<span class="text-danger">*</span></label>
                                        <input id="bsc_reg_no" name="bsc_reg_no" value="{{ old('bsc_reg_no') }}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bsc_student_id" class="@error('bsc_student_id') text-danger @enderror">Company<span class="text-danger">*</span></label>
                                        <input id="bsc_student_id" name="bsc_student_id" value="{{ old('bsc_student_id') }}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="msc_session_id" name="msc_session_id"
                                            ...
                                            <option value="">Select session</option>
                                            @foreach($sessions as $session)
                                                <option value="{{ $session->id }}" {{ old('msc_session_id') == $session->id ? 'selected' : '' }}>{{ $session->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="msc_batch_id" name="msc_batch_id"
                                            ...
                                            @foreach($batches as $batch)
                                                @if($batch->type == 2)
                                                    <option value="{{ $batch->id }}" {{ old('msc_batch_id') == $batch->id ? 'selected' : '' }}>{{ $batch->name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        @error('msc_batch_id')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="msc_reg_no" name="msc_reg_no" value="{{ old('msc_reg_no') }}" type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="msc_student_id" name="msc_student_id" value="{{ old('msc_student_id') }}" type="text"
