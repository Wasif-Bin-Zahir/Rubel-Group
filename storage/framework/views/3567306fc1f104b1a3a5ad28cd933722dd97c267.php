                    ...
                    <?php $__currentLoopData = $data->articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="blog-item-4">
                                <img style="width: 100%; height: 200px;" src="<?php echo e(url('images/default/thumbnail.jpeg')); ?>" alt="Article Image">
...
<?php echo $__env->make('front.theme1.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Front\Resources/views/theme1/article/index.blade.php ENDPATH**/ ?>