            ...
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="contact-form-area m-top-30">
                        <h4><?php echo e(__('cms.get_in_touch')); ?></h4>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group button">
                                        <button type="submit" class="bizwheel-btn theme-1"><?php echo e(__('cms.send_now')); ?></button>
                                    </div>
                                </div>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('front.theme1.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Front\Resources/views/theme1/contact/index.blade.php ENDPATH**/ ?>