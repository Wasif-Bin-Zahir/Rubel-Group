                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Create Committee Category</h3>
                            <a href="<?php echo e(route('backend.cms.committee-category.index')); ?>" type="button" class="btn btn-success btn-sm text-white float-right">View Committee Category List</a>
                        </div>
                        <?php echo Form::open(['url' => route('backend.cms.committee-category.store'), 'method' => 'committee-category', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo e(route('backend.cms.committee-category.index')); ?>" type="button" class="btn btn-dark text-white float-right">Cancel</a>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/ariful3010/expo.ahcab.net/modules/Cms/Resources/views/committee_category/create.blade.php ENDPATH**/ ?>