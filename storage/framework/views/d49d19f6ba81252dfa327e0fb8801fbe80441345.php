                    ...
                    <div class="bread-inner">
                        <div class="bread-menu">
                            <ul>
                                ...
                                <li><a href="<?php echo e(url('hotel-information')); ?>"><?php echo e(__('cms.hotelinformation')); ?></a></li>
                                ...
                                <?php if(isset($data->notice->attachment->file_url)): ?>
                                    <div class="">
                                        <object data="<?php echo e($data->notice->attachment->file_url); ?>" type="application/pdf" width="100%" height="500px">
                                            <embed id="frPDF" height="100%" width="100%" src="<?php echo e($data->notice->attachment->file_url); ?>"></embed>
...
<?php echo $__env->make('front.theme1.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My_codes\ahcab expo\advance-cms\modules/Front\Resources/views/theme1/hotelinformation/show.blade.php ENDPATH**/ ?>