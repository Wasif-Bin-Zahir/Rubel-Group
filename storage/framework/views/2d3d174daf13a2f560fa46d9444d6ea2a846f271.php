                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('backend.ums.batch.index')); ?>" type="button" class="btn btn-success btn-sm text-white float-right">View Batch List</a>
                        </div>
                        <?php echo Form::open(['url' => route('backend.ums.event.store'), 'method' => 'batch', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-md-4">
                                        <div class="form-group">
                                            <label for="type" class="<?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo e(route('backend.ums.batch.index')); ?>" type="button" class="btn btn-dark text-white float-right">Cancel</a>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Ums\Resources/views/batch/create.blade.php ENDPATH**/ ?>