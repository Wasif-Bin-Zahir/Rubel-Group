                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('backend.cms.article.index')); ?>" type="button"
                               class="btn btn-success btn-sm text-white float-right">Article List</a>
                        </div>
                        <?php echo Form::open(['url' => route('backend.cms.article.update', [$article->id]), 'method' => 'put', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>">Title <span class="text-danger">*</span></label>
                                        <input id="title" name="title" value="<?php echo e(old('title') ?: $article->title); ?>"
...
unset($__errorArgs, $__bag); ?>">Title (Bengali)</label>
                                        <input id="title_bn" name="title_bn" value="<?php echo e(old('title_bn') ?: $article->title_bn); ?>"
...
unset($__errorArgs, $__bag); ?>">Description <span class="text-danger">*</span></label>
                                        <textarea id="description" name="description" class="form-control" rows="3"
                                                  placeholder="Enter description"><?php echo old('description') ?: $article->description; ?></textarea>
...
unset($__errorArgs, $__bag); ?>">Description (Bengali)</label>
                                        <textarea id="description_bn" name="description_bn" class="form-control" rows="3"
                                                  placeholder="Enter description"><?php echo old('description_bn') ?: $article->description_bn; ?></textarea>
...
unset($__errorArgs, $__bag); ?>">Category <span class="text-danger">*</span></label>
                                        <select id="article_category_id" name="article_category_id" class="form-control  <?php $__errorArgs = ['article_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $articleCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articleCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($articleCategory->id); ?>" <?php echo e(old('article_category_id')
                                                    ? (old('article_category_id') == $articleCategory->id ? 'selected' : '')
                                                    : ($article->article_category_id == $articleCategory->id ? 'selected' : '')); ?>>
                                                    <?php echo e($articleCategory->title); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php if(isset($article->image->file_name)): ?>
                                            <span class="invalid-feedback text-dark"
                                                  role="alert"><strong>Image: <?php echo e($article->image->file_name); ?></strong></span>
                                        <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Cms\Resources/views/article/edit.blade.php ENDPATH**/ ?>