<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                    <div class="single-services-card">
                        <div class="services-img">
                            <img src="<?php echo e(asset('assets/images/services/services-img-1.png')); ?>" alt="Image">
                        </div>
                        <div class="services-content">
                            <h3>Product Analysis</h3>
                            <p>Lorem ipsum dolor consectet adipisci elit. Morbi lacus, Sed ut lacus aliquet, egestas.
                            </p>
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
                    <div class="single-services-card">
                        <div class="services-img">
                            <img src="<?php echo e(asset('assets/images/services/services-img-2.png')); ?>" alt="Image">
                        </div>
                        <div class="services-content">
                            <h3>UI Design</h3>
                            <p>Lorem ipsum dolor consectet adipisci elit. Morbi lacus, Sed ut lacus aliquet, egestas.
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
                    <div class="single-services-card">
                        <div class="services-img">
                            <img src="<?php echo e(asset('assets/images/services/services-img-3.png')); ?>" alt="Image">
                        </div>
                        <div class="services-content">
                            <h3>UX Recherche</h3>
                            <p>Lorem ipsum dolor consectet adipisci elit. Morbi lacus, Sed ut lacus aliquet, egestas.
                ...
                <div class="col-lg-3 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="800">
                    <div class="single-services-card">
                        <div class="services-img">
                            <img src="<?php echo e(asset('assets/images/services/services-img-4.png')); ?>" alt="Image">
                        </div>
                        <div class="services-content">
    ...
    <div class="project-area pt-100">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="project-slider owl-carousel owl-theme">
                        <div class="single-project-card">
                            <img src="<?php echo e(asset('assets/images/project/project-img-1.png')); ?>" alt="Image">
                        ...
                        <div class="single-project-card">
                            <img src="<?php echo e(asset('assets/images/project/project-img-2.png')); ?>" alt="Image">
                            <div class="project-content">
                                <span>Business</span>
                                <h3>Staffing Solutions</h3>
                            </div>
                        ...
                        <div class="single-project-card">
                            <img src="<?php echo e(asset('assets/images/project/project-img-3.png')); ?>" alt="Image">
                            <div class="project-content">
                                <span>Business</span>
                                <h3>Staffing Solutions</h3>
                            </div>
                        ...
                        <div class="single-project-card">
                            <img src="<?php echo e(asset('assets/images/project/project-img-4.png')); ?>" alt="Image">
                            <div class="project-content">
                                <span>Business</span>
                                <h3>Staffing Solutions</h3>
                            </div>
            ...
            <div class="project-shape-one">
                <img src="<?php echo e(asset('assets/images/shape/shape-2.png')); ?>" alt="Image">
            </div>
            <div class="project-shape-two">
                <img src="<?php echo e(asset('assets/images/shape/shape-3.png')); ?>" alt="Image">
            </div>
        </div>
    </div>
    <!--End Projects Area-->
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="skill-image">
                        <img src="<?php echo e(asset('assets/images/skill/skill-img-1.png')); ?>" alt="Image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="testimonials-slider owl-carousel owl-theme">
                <div class="single-testimonials-card">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-5">
                            <img src="<?php echo e(asset('assets/images/testimonials/testimonials-img-1.jpg')); ?>" alt="Image">
                        </div>
                ...
                <div class="single-testimonials-card">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-5">
                            <img src="<?php echo e(asset('assets/images/testimonials/testimonials-img-2.jpg')); ?>" alt="Image">
                        </div>
                        <div class="col-lg-7 col-md-7">
                            <div class="testimonials-content">
                                <p>“Lorem ipsum dolor sit amet, consectetu
    ...
    <div class="watch-video-area">
        <div class="container">
            <div class="video-img">
                <img src="<?php echo e(asset('assets/images/video-img/video-img-1.jpg')); ?>" alt="Image">
                <div class="video-content">
                    <h3>Watch Our Working Video</h3>
                    <div class="play-btn">
                        <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=6WQCJx_vEX4">
                            <img src="<?php echo e(asset('assets/images/icon/icon-1.png')); ?>" alt="Icon">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                    <div class="single-blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="<?php echo e(asset('assets/images/blog/blog-img-1.jpg')); ?>" alt="Image"></a>
                            <div class="date">
                                <p>09</p>
                                <span>May</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
                    <div class="single-blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="<?php echo e(asset('assets/images/blog/blog-img-2.jpg')); ?>" alt="Image"></a>
                            <div class="date">
                                <p>09</p>
                                <span>May</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="600">
                    <div class="single-blog-card">
                        <div class="blog-img">
                            <a href="blog-details.html"><img src="<?php echo e(asset('assets/images/blog/blog-img-3.jpg')); ?>" alt="Image"></a>
                            <div class="date">
                                <p>09</p>
                                <span>May</span>
                            </div>
...
<?php echo $__env->make('front.theme2.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My_codes\rubel group\advance-cms\modules/Front\Resources/views/theme2/home/index.blade.php ENDPATH**/ ?>