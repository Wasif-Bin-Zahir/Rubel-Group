                        ...
                        <div class="portfolio-menu">
                            <ul id="portfolio-nav" class="portfolio-nav tr-list list-inline cbp-l-filters-work">
                                ...
                                <?php $__currentLoopData = $data->committeeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $committeeCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li
                                        class="cbp-filter-item <?php echo e(request()->get('category') == $committeeCategory->id ? 'active' : ''); ?>">
                            ...
                            <div class="single-team active mb-4">
                                <div class="team-head">
                                    <div class="team-head-image"
                                        style="background-size: cover !important; background: url('<?php echo e($committeeMember->avatar->file_url ?? url('images/default/avatar.jpg')); ?>');">
                                    </div>
                                    <ul class="team-social">
                                        <li><a href="<?php echo e($committeeMember->facebook); ?>"><i
                                                    class="fa fa-facebook-official"></i></a></li>
                                        <li><a href="<?php echo e($committeeMember->twitter); ?>"><i
                                                    class="fa fa-twitter-square"></i></a></li>
                                        <li><a href="<?php echo e($committeeMember->linkedin); ?>"><i class="fa fa-linkedin"></i></a>
                                        </li>
                                        <li><a href="mailto:<?php echo e($committeeMember->email); ?>"><i
                                ...
                                <div class="t-content">
                                    <div class="content-inner">
                                        ...
                                        <span class="designation">
                                            <?php if(app()->getLocale() == 'bn'): ?>
                                                <?php echo e($committeeMember->designation_bn ?? $committeeMember->designation); ?> (<?php echo e($committeeMember->company_bn ?? $committeeMember->company_bn); ?>)
                                            <?php else: ?>
                                                <?php echo e($committeeMember->designation); ?> (<?php echo e($committeeMember->company ?? $committeeMember->company); ?>)
                                            <?php endif; ?>
                                        </span>
                                    </div>
                                </div>
...
<?php echo $__env->make('front.theme1.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My_codes\ahcab expo\advance-cms\modules/Front\Resources/views/theme1/committee/index.blade.php ENDPATH**/ ?>