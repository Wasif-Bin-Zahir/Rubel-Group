                            ...
                            <a href="<?php echo e(url('brochure/' . $notice->slug)); ?>">
                                ...
                                <?php if(isset($notice->image->file_url)): ?>
                                    ...
                                    <div class="content-box">
                                        ...
                                        <h3 class="blog-item-title"><a href="<?php echo e(url('sister-concern/' . $notice->slug)); ?>"><?php echo e(substr($notice->title, 0, 25)); ?></a></h3>
...
<?php echo $__env->make('front.theme2.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\Rubel-Group\modules/Front\Resources/views/theme2/brochure/index.blade.php ENDPATH**/ ?>