        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 col-md-7 col-12">
                    <div class="contact-form-area m-top-30" style="background: #677ae7;">
                        <h4 style="color: #fff;"><?php echo e(__('cms.registration')); ?></h4>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group button">
                                        <button type="submit" class="bizwheel-btn theme-1" style="background: #6c52cc;"><?php echo e(__('cms.submit')); ?></button>
                                    </div>
                                </div>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('front.theme1.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/ariful3010/expo.ahcab.net/modules/Front/Resources/views/theme1/registration/index.blade.php ENDPATH**/ ?>