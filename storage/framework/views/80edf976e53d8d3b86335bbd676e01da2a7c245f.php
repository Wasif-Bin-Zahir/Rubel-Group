                    ...
                    <div class="bread-inner">
                        <div class="bread-menu">
                            <ul>
                                ...
                                <li><a href="javascript:void(0)"><?php echo e(__('cms.brochure')); ?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <?php $__currentLoopData = $data->notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-md-6 col-12">
                            <a href="<?php echo e(url('brochure/' . $notice->slug)); ?>">
                                ...
                                <?php if(isset($notice->image->file_url)): ?>
                                    ...
                                    <div class="content-box">
                                        ...
                                        <h3 class="blog-item-title"><a href="<?php echo e(url('brochure/' . $notice->slug)); ?>"><?php echo e(substr($notice->title, 0, 25)); ?></a></h3>
...
<?php echo $__env->make('front.theme1.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My_codes\ahcab expo\advance-cms\modules/Front\Resources/views/theme1/brochure/index.blade.php ENDPATH**/ ?>