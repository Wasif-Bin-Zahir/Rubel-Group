            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        ...
                        <?php echo Form::open(['url' => route('backend.cms.slider.store'), 'method' => 'slider', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>">Order</label>
                                        <input id="sort_order" name="sort_order" value="<?php echo e(old('sort_order')); ?>"
                                               type="text"
...
unset($__errorArgs, $__bag); ?>">Link</label>
                                        <input id="link" name="link" value="<?php echo e(old('link')); ?>" type="text" class="form-control <?php $__errorArgs = ['link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My_codes\ahcab expo\advance-cms\modules/Cms\Resources/views/slider/create.blade.php ENDPATH**/ ?>