...
unset($__errorArgs, $__bag); ?>">Page Category Id</label>
                                        <input id="page_category_id" name="page_category_id" value="<?php echo e($page->page_category_id ?: 'N/A'); ?>" type="text" class="form-control-plaintext" readonly>
...
unset($__errorArgs, $__bag); ?>">Title</label>
                                        <input id="title" name="title" value="<?php echo e($page->title ?: 'N/A'); ?>" type="text" class="form-control-plaintext" readonly>
...
unset($__errorArgs, $__bag); ?>">Title (Bengali)</label>
                                        <input id="title_bn" name="title_bn" value="<?php echo e($page->title_bn ?: 'N/A'); ?>" type="text" class="form-control-plaintext" readonly>
...
unset($__errorArgs, $__bag); ?>
									...
									<div class="col-md-12">
                                    <div class="form-group">
                                        <label for="slug" class="<?php $__errorArgs = ['slug'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">Slug</label>
                                        <input id="slug" name="slug" value="<?php echo e($page->slug ?: 'N/A'); ?>" type="text" class="form-control-plaintext" readonly>
...
unset($__errorArgs, $__bag); ?>">Description (Bengali)</label>
                                        <div>
                                            <?php echo $page->description_bn ?: 'N/A'; ?>
...
unset($__errorArgs, $__bag); ?>">Feature Image</label>
                                        <input id="feature_image" name="feature_image" value="<?php echo e($page->image? $page->image->file_name: 'N/A'); ?>" type="text" class="form-control-plaintext" readonly>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/ariful3010/expo.ahcab.net/modules/Cms/Resources/views/page/show.blade.php ENDPATH**/ ?>