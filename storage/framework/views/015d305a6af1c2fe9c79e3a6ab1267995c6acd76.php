                ...
                <div class="col-lg-8 hide-res">
                    <div class="top-contact">
                        ...
                        <?php if($global_contact->working_hours): ?>
                            <div class="single-contact"><i class="fa fa-clock-o"></i>Event TIme: <?php echo e($global_contact->working_hours); ?></div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php /**PATH E:\My_codes\ahcab expo\advance-cms\resources\views/front/theme1/partials/_header.blade.php ENDPATH**/ ?>