            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        ...
                        <?php echo Form::open(['url' => route('backend.cms.article.store'), 'method' => 'article', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>">Title <span class="text-danger">*</span></label>
                                        <input id="title" name="title" value="<?php echo e(old('title')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>">Title (Bengali)</label>
                                        <input id="title_bn" name="title_bn" value="<?php echo e(old('title_bn')); ?>" type="text"
...
unset($__errorArgs, $__bag); ?>">Description (Bengali)</label>
                                        <textarea id="description_bn" name="description_bn" class="form-control" rows="3"
                                                  placeholder="Enter description"><?php echo e(old('description_bn')); ?></textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="article_category_id"
                                               class="<?php $__errorArgs = ['article_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> text-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">Category <span class="text-danger">*</span></label>
                                        <select id="article_category_id" name="article_category_id"
                                                class="form-control  <?php $__errorArgs = ['article_category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__currentLoopData = $articleCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $articleCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($articleCategory->id); ?>" <?php echo e(old('article_category_id') ? (old('article_category_id') == $articleCategory->id ? 'selected' : '') : ''); ?>><?php echo e($articleCategory->title); ?></option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Cms\Resources/views/article/create.blade.php ENDPATH**/ ?>