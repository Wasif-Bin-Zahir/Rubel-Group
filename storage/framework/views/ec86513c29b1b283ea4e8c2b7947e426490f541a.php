                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('backend.cms.article-category.index')); ?>" type="button" class="btn btn-success btn-sm text-white float-right">View Article Category List</a>
                        </div>
                        <?php echo Form::open(['url' => route('backend.cms.article-category.store'), 'method' => 'article-category', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="<?php echo e(route('backend.cms.article-category.index')); ?>" type="button" class="btn btn-dark text-white float-right">Cancel</a>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Cms\Resources/views/article_category/create.blade.php ENDPATH**/ ?>