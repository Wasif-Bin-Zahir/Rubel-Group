<div class="btn-group">
    ...
    <a href="<?php echo e(route('backend.cms.slider.edit', [$data->id])); ?>" type="button" class="btn btn-default">
    ...
    <?php echo Form::open(['url' => route('backend.cms.slider.destroy', [$data->id]), 'method' => 'delete', 'id' => 'delete_form' . $data->id]); ?><?php echo Form::close(); ?>

</div>
<?php /**PATH E:\My_codes\ahcab expo\advance-cms\modules/Cms\Resources/views/slider/action.blade.php ENDPATH**/ ?>