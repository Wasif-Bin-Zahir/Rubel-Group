                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-purple card-outline">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('backend.ums.academic-session.index')); ?>" type="button"
                               class="btn btn-success btn-sm text-white float-right">View Academic Session List</a>
                        </div>
                        <?php echo Form::open(['url' => route('backend.ums.academic-session.update', [$academicSession->id]), 'method' => 'put', 'files' => true]); ?>
...
unset($__errorArgs, $__bag); ?>">Name <span class="text-danger">*</span></label>
                                        <input id="name" name="name" value="<?php echo e(old('name') ?: $academicSession->name); ?>"
...
unset($__errorArgs, $__bag); ?>">Code <span class="text-danger">*</span></label>
                                        <input id="code" name="code" value="<?php echo e(old('code') ?: $academicSession->code); ?>"
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bemantech\projects\advance-cms\modules/Ums\Resources/views/academic_session/edit.blade.php ENDPATH**/ ?>